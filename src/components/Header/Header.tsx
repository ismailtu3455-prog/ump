      ...
      <header className="h-14 bg-gradient-to-r from-dark-900 via-dark-800 to-dark-900 border-b border-dark-700/50 flex items-center px-4 gap-4 flex-shrink-0 shadow-lg">
        ...
        <div className="flex items-center gap-3">
          <div className="relative group">
            <div className="absolute inset-0 bg-primary-500/30 blur-xl rounded-full group-hover:blur-2xl transition-all duration-500 animate-pulse" />
            <img 
              src="./public/Untitled Project (1).jpg" 
              alt="Logo" 
              className="relative w-9 h-9 rounded-full object-cover drop-shadow-lg group-hover:scale-110 transition-transform duration-300" 
            />
          </div>
        </div>
